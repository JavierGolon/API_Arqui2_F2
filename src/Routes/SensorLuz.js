...
router.post('/',(req,res)=>{
    var valor = req.body.Luz;
    console.log(req.body);
    var fechafull = ObtenerFecha();
    InsertarLuz(valor,fechafull);
    res.send('Insertando Luz..');
  });
...
function InsertarLuz(valor,fecha) {
    console.log("Reading rows from the Table...");
  
    // Read all rows from table
  
      //SQL satement
      var sql = "insert into luz(valor,fecha) values ('"+valor+"','"+fecha+"')"
